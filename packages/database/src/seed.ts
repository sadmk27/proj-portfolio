...
async function seed() {
    ...
    await db.insert(projects).values([
        {
            title: "My Portfolio",
            description: "A high-performance monorepo portfolio built with Vite, Hono, and Drizzle.",
            url: "https://github.com/yourhandle/portfolio",
            imageUrl: "https://placehold.co/600x400/242424/ffffff?text=Portfolio+Project",
        },
    ]);
