...
export function ExperienceCard({
  ...
  return (
    <Card className="relative flex flex-col h-full w-full max-w-full overflow-hidden border-border/40 bg-card from-card/80 to-card/40 backdrop-blur-md shadow-sm">
